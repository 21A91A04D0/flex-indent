          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to="/FlexIndentForm">{props.t("Flex Indent")}</Link>
                </li>
                <li>
                  <Link to="/FlexIndentDashboard">{props.t("Dash Board")}</Link>
                </li>
                <li>
                  <Link to="/Flex-indent-tableData">{props.t("Table Data")}</Link>
                </li>
                <li>
                  <Link to="/requests-data">{props.t("Request Data")}</Link>
                </li>
                <li>
                  <Link to='/details'>{props.t("details")}</Link>
                </li>
              </ul>
            </li>
